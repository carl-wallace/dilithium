...
pub(crate) fn mode_poly_internal(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let tokens = quote! {
        pub mod poly {
            use crate::{
              fips202::*, #mode_name::ntt::*, #mode_name::params::*, #mode_name::reduce::*, #mode_name::rounding::*, #mode_name::symmetric::*,
            };
