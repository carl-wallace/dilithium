...
pub(crate) fn mode_sign_internal(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let tokens = quote! {
        pub mod sign {
            use crate::{
              fips202::*, #mode_name::packing::*, #mode_name::params::*, #mode_name::poly::*, #mode_name::polyvec::*, randombytes::*,
              #mode_name::api::SignError,
            };
